...
angular.module('BridgeExample', 
  ...
  config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
    ...
    $routeProvider.when('/dynamic', { templateUrl: 'examples/sample/partials/dynamic.html', controller: DynamicCtrl});
    // Demo of using query parameters for search terms
    $routeProvider.when('/search', { templateUrl: 'examples/sample/partials/search.html', controller: 'SearchCtrl'});
    // Demo of using IDs within URLs - note the section ID then article ID and **then** the person ID
    $routeProvider.when('/person/view/:personId', { templateUrl: '/examples/sample/partials/person.html', controller: 'PersonCtrl'});
